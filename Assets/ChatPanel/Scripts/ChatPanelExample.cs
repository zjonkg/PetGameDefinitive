...
public class ChatPanelExample : MonoBehaviour
{
    ...
    private IEnumerator DebugChat()
    {
        ...
        wcp.AddChatAndUpdate(false, "ARIGATO PAPU", 0);
        yield return new WaitForSeconds(2);
        wcp.AddChatAndUpdate(true, "i say hello world hello world hello world hello world hello world lo world hello world hello world hello world lo world hello world hello world hello worldlo world hello world hello world hello worldlo world hello world hello world hello world ", 2);
        yield return new WaitForSeconds(2);
        wcp.AddChatAndUpdate(false, "HOLA PAPU SI ERES UN TIGRE MI LOCO JAJJAJA", 0);
    }
